<%@ Page Title="Check Out" Language="C#" MasterPageFile="~/ShowRoom.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="mobilePhoneSR.CheckOut" %>
<%@ MasterType VirtualPath="~/ShowRoom.Master" %>

<asp:Content ID="mainContent" ContentPlaceHolderID="mainPlaceholder" runat="server">       
<%--<form id="form1" runat="server" class="form-horizontal" DefaultFocus="txtEmail1" DefaultButton="btnCheckOut">--%>
<div class="row">
